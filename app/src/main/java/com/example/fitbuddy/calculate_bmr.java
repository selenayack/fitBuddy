...
public class calculate_bmr extends AppCompatActivity {
    ...
    private void kullanılanOlcu() {
        ...
        if (olcu.startsWith("k")) {
            ...
            TextView textViewOlcuBirimi = (TextView) findViewById(R.id.textViewOlcuBirimi2);
            textViewOlcuBirimi.setText("pounds");
            TextView textViewHaftalikKg = (TextView) findViewById(R.id.textViewHaftalikKg2);
    ...
    private void Bmrhesapla() {
        ...
        TextView textViewErrorMessage = (TextView) findViewById(R.id.textViewErrorMessage2);
       ...
       /* EditText editTextMevcutKilo = (EditText) findViewById(R.id.editTextMevcutKilo);
        ...
        Spinner spinnerHaftalikKg = (Spinner) findViewById(R.id.spinnerHaftalıkKg2);
    ...
    /*public void errorMesajınıSakla(){
